...
namespace APIVerve
{
    public class SSLCheckerAPIClient
    {
        ...
        public SSLCheckerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public SSLCheckerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, sslcheckerQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(sslcheckerQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(sslcheckerQueryOptions options)
        {
