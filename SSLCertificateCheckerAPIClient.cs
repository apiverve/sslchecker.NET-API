...
namespace APIVerve
{
    public class SSLCertificateCheckerAPIClient
    {
        ...
        public SSLCertificateCheckerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public SSLCertificateCheckerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
